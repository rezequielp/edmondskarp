...
void network_add(AbbNet net, Node node);/*Agrega el nodo al arbol*/
bool network_isEmpty(AbbNet net);/*Devuelve True si esta vacio False sino*/
networkNode network_search(AbbNet net, u32 key);/*Busca el elemento key en el arbol y devuelve un puntero al nodo que machea ese key*/
